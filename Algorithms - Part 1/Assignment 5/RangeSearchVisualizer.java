...
//Read points from a file (specified as a command-line arugment) and draw to standard draw.
//Also draw all of the points in the rectangle the user selects by dragging the mouse.
//The range search results using the brute-force algorithm are drawnin red,
